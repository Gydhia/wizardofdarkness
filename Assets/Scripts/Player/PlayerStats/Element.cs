...
public abstract class Element : MonoBehaviour
{
    ...
    public abstract void ChangementFX(ParticleSystem part);/*  Cette fonction, override dans les autres, va gérer les FX qu'on déclencheras lors d'un changement. La différence entre cette méthode et UpdateStats;
